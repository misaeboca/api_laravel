    ...
    <section id="wrapper">
        <div class="login-register">
            <div class="login-box card" style="max-width:25%; padding-bottom:0px;">
                ...
                <div class="card-body">
                    <h4 class="box-title  text-center font-14" >REGISTRO DE USUARIO</h4>
                    <form class="form-horizontal" id="loginform" action="{{ url('/registrarse') }}" method="POST">
                        ...
                        <div class=" text-center">
                            <div class="col-xs-12">
                                <button class="btn btn-login  btn-block text-uppercase waves-effect waves-light text-white" type="submit" style="background-color: #d5521c">Guardar</button>
                            </div>
                        </div>
                    </form>
