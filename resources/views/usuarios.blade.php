        ...
        <div class="modal-content" style="border: solid 1px orange;">
            ...
            <form class="form-material" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="w3-left col-md-12 m-t-10 m-b-10">
                            <input type="text" class="form-control form-control-sm" placeholder="Usuario" name="usuario" id="usuario">
                        </div>
                        <div class="w3-left col-md-12 m-t-10 m-b-10">
                        ...
                        <div class="w3-left col-md-12 m-t-10 m-b-10">
                            <input class="form-control" type="password" required="" name="password" placeholder="Contraseña" id="password">  
                        </div>
                        <div class="w3-left col-md-12 m-t-10 m-b-10" style="padding-top: 10px;">
                            <label>Tipo de Usuario</label>
                            <select class="form-control custom-select" name="tipo" id="tipo" data-placeholder="Elegir un Cargo" tabindex="1">
