...
Route::any('/registrarse', ['uses' => 'Auth\LoginController@registrarse'])->name('logout');
Route::any('/registrar_usuario', ['uses' => 'Auth\LoginController@registrar_usuario'])->name('logout');
